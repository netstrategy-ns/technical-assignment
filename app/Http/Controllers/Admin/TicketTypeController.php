...
class TicketTypeController extends Controller
{
    ...
    {
        $modelClass = TicketType::class;
        $resource = 'ticket-types';

        $query = TicketType::query()->with(['event:id,title', 'venueType:id,name']);
        ...
        return Inertia::render('admin/ticket-types/Index', [
            'resource' => $resource,
            'resources' => [
                ['id' => $resource, 'label' => 'Tipologie'],
            ],
